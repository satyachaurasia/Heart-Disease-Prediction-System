...
$SQL = "DELETE  FROM addtdata WHERE username = '$username'";
$result = mysqli_query($con, $SQL);

    
		mysqli_query($con, "INSERT INTO addtdata (username,age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal) VALUES ('$username','$age', '$sex', '$cp', '$trestbps', '$chol', '$fbs', '$restecg', '$thalach', '$exang', '$oldpeak', '$slope', '$ca', '$thal')"); 

		$command_output = shell_exec("C:\\Users\\Anju\\AppData\\Local\\Programs\\Python\\Python35\\python C:\\xampp\\htdocs\\hdps\\main.py 2>&1");
...
<ul class="w3-navbar w3-light-grey ">
  <li><a  class=" w3-black" href="patientsdata.php">Patient Data</a></li>
