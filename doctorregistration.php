...
if (isset($_POST['submit'])) {
	...
	$specialistin = mysqli_real_escape_string($con, $_POST['specialistin']);
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO doctor(name,username,address,mobileno,email,age,gender,specialistin,password) VALUES('" . $name . "','" . $username . "', '" . $address . "','" . $mobileno . "','" . $email . "','" . $age . "','" . $gender . "','" . $specialistin . "', '" . $password . "')")) {
			$successmsg = "Successfully Registered! <a href='doctorlogin.php'>Click here to Login</a>";
		} else {
...
<div class="container">
		...
		<div class="col-md-4 col-md-offset-4 well">
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						<label for="name">Specialist In</label>
						<input type="text" name="specialistin" placeholder="Specialist In" required value="<?php if($error) echo $specialistin; ?>" class="form-control" />
						<span class="text-danger"><?php if (isset($specialistin_error)) echo $specialistin_error; ?></span>
					</div>
	...
	<div class="row">
		...
		Already Registered? <a href="doctorlogin.php">Login Here</a>
		</div>
	</div>
</div>
